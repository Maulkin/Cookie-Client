...
import meteordevelopment.cookieclient.gui.DefaultSettingsWidgetFactory;
import meteordevelopment.cookieclient.gui.GuiTheme;
import meteordevelopment.cookieclient.gui.WidgetScreen;
import meteordevelopment.cookieclient.gui.renderer.packer.GuiTexture;
import meteordevelopment.cookieclient.gui.themes.meteor.widgets.*;
import meteordevelopment.cookieclient.gui.themes.meteor.widgets.input.WMeteorDropdown;
import meteordevelopment.cookieclient.gui.themes.meteor.widgets.input.WMeteorSlider;
import meteordevelopment.cookieclient.gui.themes.meteor.widgets.input.WMeteorTextBox;
import meteordevelopment.cookieclient.gui.themes.meteor.widgets.pressable.*;
import meteordevelopment.cookieclient.gui.utils.AlignmentX;
import meteordevelopment.cookieclient.gui.utils.CharFilter;
import meteordevelopment.cookieclient.gui.widgets.*;
...
import meteordevelopment.cookieclient.gui.widgets.input.WSlider;
import meteordevelopment.cookieclient.gui.widgets.input.WTextBox;
import meteordevelopment.cookieclient.gui.widgets.pressable.*;
